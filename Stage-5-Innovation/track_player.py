...
from gui_combine import GuiCombine
...
def gui_combine():
    status_lbl.configure(text="GUI combine button was clicked!")
    GuiCombine(tk.Toplevel(window))
...
gui_combine = tk.Button(window, text="GUI combine", command=gui_combine)
gui_combine.grid(row=1, column=3, padx=10, pady=10)
